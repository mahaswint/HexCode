...
//   const [hasMore, setHasMore] = useEffect(true);
//   const [visibleTemplates, setVisibleTemplates] = useEffect(templates.slice(0,3));

//   const loadMoreTemplates = () => {
//     setTimeout(() => {
//       setVisibleTemplates((prevTemplates) => {
//         const nextIndex = prevTemplates.length;
//         const nextTemplates = templates.slice(nextIndex, nextIndex + 3);
        
//         if (nextTemplates.length === 0) {
//           setHasMore(false); // Stop loading if no more templates
//           return prevTemplates; // Return previous state if nothing new to add
//         }
...
//             <div 
//               key={index} 
//               className="transform hover:scale-104 transition-all duration-1000 shadow-md hover:shadow-lg rounded-xl overflow-hidden bg-gray-800"
//             >
//               <TemplateCard 
//                 id={0}
